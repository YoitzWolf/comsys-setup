...
/*
pub async fn compet_reader<Participant, Team>(data: Vec<u8>)
-> Result<(Vec<Participant>, Vec<Team>), Box<dyn Error>> 

    where
        Participant: Debug + Clone + From<(Vec<std::string::String>, Vec<std::string::String>)>,
        Team:        Debug + Clone + From<(Vec<std::string::String>, Vec<std::string::String>)>
